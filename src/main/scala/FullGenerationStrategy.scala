...
class FullGenerationStrategy[T](nonterminals: Seq[NonterminalNodeFunction[T]], terminals: Seq[TerminalNodeFunction[T]]) extends PseudorandomGenerationStrategy[T](nonterminals, terminals) {
